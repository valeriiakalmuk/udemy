		...
		<div class="row custom-negative-margin-2 m-b-xlg">
			<div class="col-lg-12">
				...
				<?php if ( $has_event_date && $show_count_down ) : ?>
					...
					<?php
						$string_hours    = esc_html__( 'Hr', 'porto' );
						$string_hours2   = esc_html__( 'Hrs', 'porto' );
						$string_minutes  = esc_html__( 'Min', 'porto' );
						$string_minutes2 = esc_html__( 'Mins', 'porto' );
						$string_seconds  = esc_html__( 'Sec', 'porto' );
						$string_seconds2 = esc_html__( 'Secs', 'porto' );
						...
						echo do_shortcode(
							'[porto_countdown 
								...
								string_hours="' . $string_hours . '" 
								string_hours2="' . $string_hours2 . '" 
								string_minutes="' . $string_minutes . '" 
								string_minutes2="' . $string_minutes2 . '" 
								string_seconds="' . $string_seconds . '" 
								string_seconds2="' . $string_seconds2 . '" 
