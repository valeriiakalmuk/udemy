...
function porto_css() {
	...
	// dokan font awesome
	if ( empty( $porto_settings_optimize['enqueue_dokan_rc'] ) ) {
...
function porto_scripts() {
	...
	if ( ! is_admin() && ! in_array( $GLOBALS['pagenow'], array( 'wp-login.php', 'wp-register.php' ) ) ) {
		...
		$porto_vars  = array(
			...
			'product_thumbs_count'      => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['product-thumbs-count'] : '' ),
			'product_zoom'              => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['product-zoom'] : '' ),
			'product_zoom_mobile'       => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['product-zoom-mobile'] : '' ),
			'product_image_popup'       => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['product-image-popup'] : '' ),
			'zoom_type'                 => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['zoom-type'] : '' ),
			'zoom_scroll'               => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['zoom-scroll'] : '' ),
			'zoom_lens_size'            => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['zoom-lens-size'] : '' ),
			'zoom_lens_shape'           => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['zoom-lens-shape'] : '' ),
			'zoom_contain_lens'         => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['zoom-contain-lens'] : '' ),
			'zoom_lens_border'          => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['zoom-lens-border'] : '' ),
			'zoom_border_color'         => esc_js( class_exists( 'WooCommerce' ) ? $porto_settings['zoom-border-color'] : '' ),
			'zoom_border'               => esc_js( ( ! class_exists( 'WooCommerce' ) || 'inner' == $porto_settings['zoom-type'] ) ? 0 : $porto_settings['zoom-border'] ),
...
function custom_override_checkout_fields( $fields ) {
    ...
    $fields['account']['account_privacy_policy'] = array(
        'type' => 'checkbox',
        'required'  => true,
    ...
    $fields['account']['account_reg'] = array(
        'type' => 'checkbox',
        'required' => true,
