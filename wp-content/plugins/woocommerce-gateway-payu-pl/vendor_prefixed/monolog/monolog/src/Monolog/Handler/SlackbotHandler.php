 ...
 */
class SlackbotHandler extends \WGPayuVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \WGPayuVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
