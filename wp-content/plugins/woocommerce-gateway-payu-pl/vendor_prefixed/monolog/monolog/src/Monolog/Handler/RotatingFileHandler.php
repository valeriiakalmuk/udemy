 ...
 */
class RotatingFileHandler extends \WGPayuVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \WGPayuVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \WGPayuVendor\Monolog\Utils::canonicalizePath($filename);
