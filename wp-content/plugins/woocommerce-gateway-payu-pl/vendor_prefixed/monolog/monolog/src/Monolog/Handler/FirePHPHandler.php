...
use WGPayuVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \WGPayuVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \WGPayuVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
