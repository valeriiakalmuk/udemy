 ...
 */
class BrowserConsoleHandler extends \WGPayuVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \WGPayuVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
