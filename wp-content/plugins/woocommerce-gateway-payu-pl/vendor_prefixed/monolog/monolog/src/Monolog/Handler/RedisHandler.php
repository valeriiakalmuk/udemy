 ...
 */
class RedisHandler extends \WGPayuVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $redisKey;
    protected $capSize;
     ...
     */
    public function __construct($redis, $key, $level = \WGPayuVendor\Monolog\Logger::DEBUG, $bubble = \true, $capSize = \false)
    {
        if (!($redis instanceof \WGPayuVendor\Predis\Client || $redis instanceof \Redis)) {
