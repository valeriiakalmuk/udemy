 ...
 */
abstract class AbstractHandler implements \WGPayuVendor\Monolog\Handler\HandlerInterface, \WGPayuVendor\Monolog\ResettableInterface
{
    protected $level = \WGPayuVendor\Monolog\Logger::DEBUG;
    ...
    {
        $this->level = \WGPayuVendor\Monolog\Logger::toMonologLevel($level);
        return $this;
    }
    /**
