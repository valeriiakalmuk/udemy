 ...
 */
class PushoverHandler extends \WGPayuVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \WGPayuVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \WGPayuVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \WGPayuVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \WGPayuVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \WGPayuVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
