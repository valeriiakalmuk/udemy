...
namespace WGPayuVendor\WPDesk\License\Page\License\Action;

use WGPayuVendor\WPDesk\License\Page\Action;
use WGPayuVendor\WPDesk\License\ServerAddressRepository;
 ...
 */
class LicenseActivation extends \WGPayuVendor\WPDesk\License\Page\License\Action\AbstractAction implements \WGPayuVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    public function execute(array $plugin)
    {
        ...
        $this->activate_license($activation_email, $api_key, new \WGPayuVendor\WPDesk\License\ServerAddressRepository($product_id));
    }
    /**
     ...
     */
    public function activate_license($activation_email, $api_key, \WGPayuVendor\WPDesk\License\ServerAddressRepository $address_repository)
    {
