...
namespace WGPayuVendor\WPDesk\License\Changelog;

use ArrayObject;
use WGPayuVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \WGPayuVendor\WPDesk\License\Changelog\Parser\Line($line);
