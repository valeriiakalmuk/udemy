...
if (!\interface_exists('WGPayuVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('WGPayuVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('WGPayuVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \WGPayuVendor\WPDesk_Translatable, \WGPayuVendor\WPDesk_Buildable, \WGPayuVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
