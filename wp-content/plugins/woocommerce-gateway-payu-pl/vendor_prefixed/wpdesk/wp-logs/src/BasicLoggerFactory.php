 ...
 */
class BasicLoggerFactory implements \WGPayuVendor\WPDesk\Logger\LoggerFactory
{
    ...
    public function createLogger($name, $handlers = array(), array $processors = array())
    {
        ...
        $logger = new \WGPayuVendor\Monolog\Logger($name, $handlers, $processors);
        \WGPayuVendor\Monolog\Registry::addLogger($logger);
        return $logger;
    }
    /**
