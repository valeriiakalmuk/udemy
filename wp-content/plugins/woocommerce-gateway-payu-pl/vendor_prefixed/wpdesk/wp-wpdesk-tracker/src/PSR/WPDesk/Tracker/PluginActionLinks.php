 ...
 */
class PluginActionLinks implements \WGPayuVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
     * @var string
     */
    ...
    public function append_plugin_action_links($links)
    {
        ...
        $tracker_consent = new \WGPayuVendor\WPDesk_Tracker_Persistence_Consent();
        $plugin_links = array();
