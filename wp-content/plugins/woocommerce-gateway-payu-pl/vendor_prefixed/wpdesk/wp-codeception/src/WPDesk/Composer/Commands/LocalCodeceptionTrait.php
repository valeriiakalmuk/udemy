...
trait LocalCodeceptionTrait
{
     ...
     * @param Configuration   $configuration
     */
    private function installPlugin($plugin_dir, \WGPayuVendor\Symfony\Component\Console\Output\OutputInterface $output, \WGPayuVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
