 ...
 */
class GeneratePluginActivation extends \WGPayuVendor\Codeception\Command\GenerateTest implements \WGPayuVendor\Codeception\CustomCommandInterface
{
    /**
    ...
    {
        return new \WGPayuVendor\WPDesk\Codeception\Command\AcceptanceTestGenerator($config, $class);
    }
    /**
     * Execute command.
     *
