...
class WPS_Widgets extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$classes = array(
			'1' => ( WPS()->bootstrap_version == 'version_3' ) ? 'col-xs-12' : 'col-12',
			'2' => ( WPS()->bootstrap_version == 'version_3' ) ? 'col-xs-6' : 'col-6',
			'3' => ( WPS()->bootstrap_version == 'version_3' ) ? 'col-sm-4 col-xs-6' : 'col-sm-4 col-6',
			'4' => ( WPS()->bootstrap_version == 'version_3' ) ? 'col-sm-3 col-xs-6' : 'col-sm-3 col-6'
		);
