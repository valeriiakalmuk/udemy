 ...
 */
class SettingsPage implements \ActivePaymentsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Settings', 'woocommerce_activepayments'), \__('Settings', 'woocommerce_activepayments'), 'manage_options', 'wpdesk-helper-settings', function () {
    ...
    private function handle_render_wpdesk_helper_settings()
    {
        ...
        <div class="wrap">
            <h1><?php 
        \_e('WP Desk Helper Settings', 'woocommerce_activepayments');
        ?></h1>
