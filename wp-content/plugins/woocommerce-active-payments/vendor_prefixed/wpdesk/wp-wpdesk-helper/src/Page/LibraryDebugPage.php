...
namespace ActivePaymentsVendor\WPDesk\Helper\Page;
 ...
 */
class LibraryDebugPage implements \ActivePaymentsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    const PRIOTITY_LONG_AFTER_ALL_IS_LOADED = 999;
    /** @var LibraryDebug */
    private $library_debug;
    public function __construct(\ActivePaymentsVendor\WPDesk\Helper\Debug\LibraryDebug $library_debug)
    {
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'woocommerce_activepayments'), \__('Library report', 'woocommerce_activepayments'), 'manage_options', 'wpdesk-helper-library-report', function () {
