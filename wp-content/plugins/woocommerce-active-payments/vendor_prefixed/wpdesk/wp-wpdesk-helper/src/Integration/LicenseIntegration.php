...
use ActivePaymentsVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \ActivePaymentsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \ActivePaymentsVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \ActivePaymentsVendor\WPDesk\License\Page\LicensePage($plugin_registry);
