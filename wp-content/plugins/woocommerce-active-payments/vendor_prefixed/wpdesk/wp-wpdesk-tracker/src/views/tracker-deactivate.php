...
<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'woocommerce_activepayments'), $plugin_name);
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'woocommerce_activepayments');
?></strong></h4>
			<ul id="reasons-list">
                <li class="reason">
                    <label>
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin suddenly stopped working', 'woocommerce_activepayments');
?></span>
                    </label>
                </li>
                <li class="reason">
	            	...
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin broke my site', 'woocommerce_activepayments');
?></span>
                    </label>
                </li>
				<li class="reason has-input">
					<label>
						...
						<span><?php 
\_e('I found a better plugin', 'woocommerce_activepayments');
?></span>
					</label>
					<div id="found_better_plugin" class="reason-input">
						<input type="text" name="better_plugin_name" placeholder="<?php 
\_e('What\'s the plugin\'s name?', 'woocommerce_activepayments');
?>">
					</div>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I only needed the plugin for a short period', 'woocommerce_activepayments');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I no longer need the plugin', 'woocommerce_activepayments');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'woocommerce_activepayments');
?></span>
					</label>
				</li>
				<li class="reason has-input">
	            	...
	            	<span>
						...
						<span><?php 
\_e('Other', 'woocommerce_activepayments');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\_e('Kindly tell us the reason so we can improve', 'woocommerce_activepayments');
?>">
					</div>
				</li>
			</ul>
...
\_e('Cancel', 'woocommerce_activepayments');
?></a>
        <a href="#" class="button button-primary button-deactivate allow-deactivate"><?php 
\_e('Skip &amp; Deactivate', 'woocommerce_activepayments');
?></a>
	</div>
</div>
...
\_e('Submit &amp; Deactivate', 'woocommerce_activepayments');
?>' );
	})
