...
class LicensePage implements \ActivePaymentsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Subscriptions', 'woocommerce_activepayments'), \__('Subscriptions', 'woocommerce_activepayments'), 'manage_options', self::PAGE_SLUG, [$this, 'handle_render_wpdesk_licenses_page']);
    }
    /**
