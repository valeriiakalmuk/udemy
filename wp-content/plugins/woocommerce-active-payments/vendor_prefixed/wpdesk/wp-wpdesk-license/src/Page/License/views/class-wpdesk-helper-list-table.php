...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'woocommerce_activepayments'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'woocommerce_activepayments'), 'product_status' => \__('Subscription Status', 'woocommerce_activepayments'), 'product_license' => \__('Subscription Data', 'woocommerce_activepayments')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'woocommerce_activepayments');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'woocommerce_activepayments');
        }
        return $status;
    }
