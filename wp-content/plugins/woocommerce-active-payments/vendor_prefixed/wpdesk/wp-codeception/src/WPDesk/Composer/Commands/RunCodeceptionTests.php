...
use ActivePaymentsVendor\Symfony\Component\Console\Input\InputArgument;
 ...
 */
class RunCodeceptionTests extends \ActivePaymentsVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    const SINGLE = 'single';
    const FAST = 'fast';
    ...
    {
        parent::configure();
        $this->setName('run-codeception-tests')->setDescription('Run codeception tests.')->setDefinition(array(new \ActivePaymentsVendor\Symfony\Component\Console\Input\InputArgument(self::SINGLE, \ActivePaymentsVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Name of Single test to run.', 'all'), new \ActivePaymentsVendor\Symfony\Component\Console\Input\InputArgument(self::FAST, \ActivePaymentsVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Fast tests - do not shutdown docker-compose.', 'slow'), new \ActivePaymentsVendor\Symfony\Component\Console\Input\InputArgument(self::WOOCOMMERCE_VERSION, \ActivePaymentsVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'WooCommerce version to install.', '')));
    }
    /**
     * Execute command.
     *
     ...
     * @return void
     */
    protected function execute(\ActivePaymentsVendor\Symfony\Component\Console\Input\InputInterface $input, \ActivePaymentsVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
