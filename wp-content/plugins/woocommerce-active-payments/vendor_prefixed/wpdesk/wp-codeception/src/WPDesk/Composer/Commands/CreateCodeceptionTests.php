...
use ActivePaymentsVendor\Composer\Downloader\FilesystemException;
 ...
 */
class CreateCodeceptionTests extends \ActivePaymentsVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \ActivePaymentsVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
