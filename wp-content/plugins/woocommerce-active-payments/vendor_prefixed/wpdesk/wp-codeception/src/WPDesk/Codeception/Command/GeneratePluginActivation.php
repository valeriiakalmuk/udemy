 ...
 */
class GeneratePluginActivation extends \ActivePaymentsVendor\Codeception\Command\GenerateTest implements \ActivePaymentsVendor\Codeception\CustomCommandInterface
{
    /**
    ...
    {
        return new \ActivePaymentsVendor\WPDesk\Codeception\Command\AcceptanceTestGenerator($config, $class);
    }
    /**
     * Execute command.
     *
