...
if (!\interface_exists('ActivePaymentsVendor\\WPDesk_Requirement_Checker')) {
    require_once 'Requirement_Checker.php';
}
if (!\class_exists('ActivePaymentsVendor\\WPDesk_Basic_Requirement_Checker')) {
    /**
     * Checks requirements for plugin
     * have to be compatible with PHP 5.3.x
     */
    class WPDesk_Basic_Requirement_Checker implements \ActivePaymentsVendor\WPDesk_Requirement_Checker
    {
        ...
        {
            return \defined('ActivePaymentsVendor\\WC_VERSION') && \version_compare(\ActivePaymentsVendor\WC_VERSION, $min_version, '>=');
        }
        /**
