...
use ActivePaymentsVendor\Monolog\Handler\AbstractProcessingHandler;
use ActivePaymentsVendor\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \ActivePaymentsVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \ActivePaymentsVendor\Monolog\Logger::getLevelName($level);
    }
