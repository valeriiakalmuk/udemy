...
use ActivePaymentsVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \ActivePaymentsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \ActivePaymentsVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
