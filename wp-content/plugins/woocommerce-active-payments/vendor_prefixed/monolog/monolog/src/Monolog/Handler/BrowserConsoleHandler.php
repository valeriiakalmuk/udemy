 ...
 */
class BrowserConsoleHandler extends \ActivePaymentsVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \ActivePaymentsVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
