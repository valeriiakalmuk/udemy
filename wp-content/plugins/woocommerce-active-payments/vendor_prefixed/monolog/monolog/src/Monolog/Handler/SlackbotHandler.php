 ...
 */
class SlackbotHandler extends \ActivePaymentsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \ActivePaymentsVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
