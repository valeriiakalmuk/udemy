 ...
 */
class SocketHandler extends \ActivePaymentsVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \ActivePaymentsVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
