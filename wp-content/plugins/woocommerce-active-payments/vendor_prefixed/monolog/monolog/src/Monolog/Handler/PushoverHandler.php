 ...
 */
class PushoverHandler extends \ActivePaymentsVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \ActivePaymentsVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \ActivePaymentsVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \ActivePaymentsVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \ActivePaymentsVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \ActivePaymentsVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
