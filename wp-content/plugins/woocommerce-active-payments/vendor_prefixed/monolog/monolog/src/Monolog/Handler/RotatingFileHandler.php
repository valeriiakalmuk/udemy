 ...
 */
class RotatingFileHandler extends \ActivePaymentsVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \ActivePaymentsVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \ActivePaymentsVendor\Monolog\Utils::canonicalizePath($filename);
