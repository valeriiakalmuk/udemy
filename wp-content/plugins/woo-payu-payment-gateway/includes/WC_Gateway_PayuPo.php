...
class WC_Gateway_PayuPo extends WC_PayUGateways
{
    protected $paytype = 'dpp';

    function __construct()
    {
        parent::__construct('payupo');

        if ($this->is_enabled()) {
            $this->show_terms_info = true;
            $this->icon = apply_filters('woocommerce_payu_icon', plugins_url( '/assets/images/LOGO_paypo.svg', PAYU_PLUGIN_FILE ));
